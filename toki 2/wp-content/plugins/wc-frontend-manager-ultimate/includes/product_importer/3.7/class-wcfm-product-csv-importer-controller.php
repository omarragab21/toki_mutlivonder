...
class WCFM_Product_CSV_Importer_Controller
{
     ...
     * @param  boolean $check_path Whether to also check the file is located in a valid location (Default: true).
     * @return boolean
     */
     ...
     * @param  boolean $num_indexes If should use numbers or raw header columns as indexes.
     * @return array
     */
    ...
    }//end sanitize_special_column_name_regex()
