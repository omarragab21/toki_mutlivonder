...
<div class="wrap woocommerce">
    ...
    <form id="wc-bookings-booking-form" method="POST" data-nonce="<?php echo esc_attr(wp_create_nonce('find-booked-day-blocks')); ?>">
        <table class="form-table">
            <tbody>
                ...
                <tr valign="top">
                    <th scope="row">&nbsp;</th>
                    <td>
                        <input type="submit" name="create_booking_2" class="wcfm_submit_button" value="<?php _e('Add Booking', 'woocommerce-bookings'); ?>" />
