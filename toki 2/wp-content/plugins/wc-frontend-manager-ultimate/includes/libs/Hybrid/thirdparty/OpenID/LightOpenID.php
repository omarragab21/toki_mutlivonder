...
class LightOpenID
{
    ...
    function validate()
    {
        ...
        } else if (isset($this->data['openid_claimed_id'])
     ...
     *
     * @return string|boolean OAuth request token on success, FALSE if no token was provided.
     */
