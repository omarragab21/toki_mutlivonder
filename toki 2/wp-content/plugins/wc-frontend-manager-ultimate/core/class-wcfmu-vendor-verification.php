...
class WCFMu_Vendor_Verification
{
    ...
    function wcfm_vendor_auth_requests()
    {
        ...
        $wcfm_social_providers = array(
            'Google'   => array(
                'enabled' => true,
                'keys'    => array(
                    'id'     => $verify_google_client_id,
                    'secret' => $verify_google_client_secret,
                ),
            ...
            'Facebook' => array(
                'enabled'        => true,
                'keys'           => array(
                    'id'     => $verify_facebook_client_id,
                    'secret' => $verify_facebook_client_secret,
                ),
            ...
            'Twitter'  => array(
                'enabled' => true,
                'keys'    => array(
                    'key'    => $verify_twitter_client_id,
                    'secret' => $verify_twitter_client_secret,
                ),
            ),
            'LinkedIn' => array(
                'enabled' => true,
                'keys'    => array(
                    'key'    => $verify_linkedin_client_id,
                    'secret' => $verify_linkedin_client_secret,
                ),
            ),
        );

        $wcfm_social_config = array(
            'base_url'   => get_wcfm_profile_url(),
            'debug_mode' => false,
    ...
    function wcfmu_vendor_verification_settings($wcfm_options)
    {
        ...
        if (!$verification_badge) {
            $verification_badge = $WCFMu->plugin_url . 'assets/images/verification_badge.png';
        }
...
?>
        ...
        <div class="wcfm-container">
            <div id="wcfm_settings_form_vendor_verification_expander" class="wcfm-content">
                ...
                $WCFM->wcfm_fields->wcfm_generate_form_field(
                    apply_filters(
                        'wcfmu_settings_fields_vendor_verification_general',
                        array(
                            'verification_badge' => array(
                                'label'       => __('Verification Badge', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verification_badge]',
                                'type'        => 'upload',
                                'class'       => 'wcfm_ele',
                                'prwidth'     => 64,
                                'label_class' => 'wcfm_title wcfm_ele',
                                'hints'       => __('Upload badge image 32x32 size for best view.', 'wc-frontend-manager-ultimate'),
                                'value'       => $verification_badge,
                            ),
                            'verification_product_limit' => array(
                                'label'       => __('Product Limit Restriction', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verification_product_limit]',
                                'type'        => 'number',
                                'class'       => 'wcfm-text wcfm_ele',
                                'label_class' => 'wcfm_title wcfm_ele',
                                'hints'       => __('This limit will be applicable till vendor profile not verified.', 'wc-frontend-manager-ultimate'),
                                'placeholder' => __('As per capability', 'wc-frontend-manager-ultimate'),
                ...
                $WCFM->wcfm_fields->wcfm_generate_form_field(
                    apply_filters(
                        'wcfmu_settings_fields_vendor_verification_identity_types',
                        array(
                            'wcfm_vendor_verification_identity_types' => array(
                                'label'       => __('Identity Types', 'wc-frontend-manager-ultimate'),
                                'type'        => 'multiinput',
                                'class'       => 'wcfm-text wcfm_ele',
                                'label_class' => 'wcfm_title',
                                'value'       => $wcfm_vendor_verification_identity_types,
                                'options'     => array(
                                    'is_active'     => array(
                                    ...
                                    'identity_name' => array(
                                        'label'       => __('Identity Name', 'wc-frontend-manager-ultimate'),
                                        'type'        => 'text',
                                        'class'       => 'wcfm-text wcfm_ele',
                                        'label_class' => 'wcfm_title wcfm_ele',
                                    ),
                ...
                $WCFM->wcfm_fields->wcfm_generate_form_field(
                    apply_filters(
                        'wcfmu_settings_fields_vendor_verification_google',
                        array(
                            'verify_by_google'        => array(
                                'label'       => __('Enable', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verify_by_google]',
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele',
                                'label_class' => 'wcfm_title checkbox_title wcfm_ele',
                                'value'       => 'yes',
                                'dfvalue'     => $verify_by_google,
                            ),
                            'verify_google_redirect_url' => array(
                                'label'       => __('Redirect URL', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verify_google_redirect_url]',
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele',
                                'label_class' => 'wcfm_title wcfm_ele',
                                'hints'       => __('User will be redirect to the URL after successful authentication.', 'wc-frontend-manager-ultimate'),
                                'attributes'  => array('readonly' => true),
                                'value'       => $verify_google_redirect_url,
                            ),
                            'verify_google_client_id' => array(
                                'label'       => __('Client ID', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verify_google_client_id]',
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele',
                                'label_class' => 'wcfm_title wcfm_ele',
                                'hints'       => __('App generated Client ID required.', 'wc-frontend-manager-ultimate'),
                                'value'       => $verify_google_client_id,
                            ),
                            'verify_google_client_secret' => array(
                                'label'       => __('Client Secret', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verify_google_client_secret]',
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele',
                                'label_class' => 'wcfm_title wcfm_ele',
                                'hints'       => __('App generated Client Secret key required.', 'wc-frontend-manager-ultimate'),
                                'value'       => $verify_google_client_secret,
                            ),
                        )
                    )
                );
                ...
                $WCFM->wcfm_fields->wcfm_generate_form_field(
                    apply_filters(
                        'wcfmu_settings_fields_vendor_verification_facebook',
                        array(
                            'verify_by_facebook' => array(
                                'label'       => __('Enable', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verify_by_facebook]',
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele',
                                'label_class' => 'wcfm_title checkbox_title wcfm_ele',
                                'value'       => 'yes',
                                'dfvalue'     => $verify_by_facebook,
                            ),
                            'verify_facebook_redirect_url' => array(
                                'label'       => __('Redirect URL', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verify_facebook_redirect_url]',
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele',
                                'label_class' => 'wcfm_title wcfm_ele',
                                'hints'       => __('User will be redirect to the URL after successful authentication.', 'wc-frontend-manager-ultimate'),
                                'attributes'  => array('readonly' => true),
                                'value'       => $verify_facebook_redirect_url,
                            ),
                            'verify_facebook_client_id' => array(
                                'label'       => __('Client ID', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verify_facebook_client_id]',
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele',
                                'label_class' => 'wcfm_title wcfm_ele',
                                'hints'       => __('App generated Client ID required.', 'wc-frontend-manager-ultimate'),
                                'value'       => $verify_facebook_client_id,
                            ),
                            'verify_facebook_client_secret' => array(
                                'label'       => __('Client Secret', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verify_facebook_client_secret]',
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele',
                                'label_class' => 'wcfm_title wcfm_ele',
                                'hints'       => __('App generated Client Secret key required.', 'wc-frontend-manager-ultimate'),
                                'value'       => $verify_facebook_client_secret,
                            ),
                        )
                    )
                );
                ...
                $WCFM->wcfm_fields->wcfm_generate_form_field(
                    apply_filters(
                        'wcfmu_settings_fields_vendor_verification_linkedin',
                        array(
                            'verify_by_linkedin' => array(
                                'label'       => __('Enable', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verify_by_linkedin]',
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele',
                                'label_class' => 'wcfm_title checkbox_title wcfm_ele',
                                'value'       => 'yes',
                                'dfvalue'     => $verify_by_linkedin,
                            ),
                            'verify_linkedin_redirect_url' => array(
                                'label'       => __('Redirect URL', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verify_linkedin_redirect_url]',
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele',
                                'label_class' => 'wcfm_title wcfm_ele',
                                'hints'       => __('User will be redirect to the URL after successful authentication.', 'wc-frontend-manager-ultimate'),
                                'attributes'  => array('readonly' => true),
                                'value'       => $verify_linkedin_redirect_url,
                            ),
                            'verify_linkedin_client_id' => array(
                                'label'       => __('Client ID', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verify_linkedin_client_id]',
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele',
                                'label_class' => 'wcfm_title wcfm_ele',
                                'hints'       => __('App generated Client ID required.', 'wc-frontend-manager-ultimate'),
                                'value'       => $verify_linkedin_client_id,
                            ),
                            'verify_linkedin_client_secret' => array(
                                'label'       => __('Client Secret', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verify_linkedin_client_secret]',
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele',
                                'label_class' => 'wcfm_title wcfm_ele',
                                'hints'       => __('App generated Client Secret key required.', 'wc-frontend-manager-ultimate'),
                                'value'       => $verify_linkedin_client_secret,
                            ),
                        )
                    )
                );
                ...
                $WCFM->wcfm_fields->wcfm_generate_form_field(
                    apply_filters(
                        'wcfmu_settings_fields_vendor_verification_twitter',
                        array(
                            'verify_by_twitter'        => array(
                                'label'       => __('Enable', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verify_by_twitter]',
                                'type'        => 'checkbox',
                                'class'       => 'wcfm-checkbox wcfm_ele',
                                'label_class' => 'wcfm_title checkbox_title wcfm_ele',
                                'value'       => 'yes',
                                'dfvalue'     => $verify_by_twitter,
                            ),
                            'verify_twitter_redirect_url' => array(
                                'label'       => __('Redirect URL', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verify_twitter_redirect_url]',
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele',
                                'label_class' => 'wcfm_title wcfm_ele',
                                'hints'       => __('User will be redirect to the URL after successful authentication.', 'wc-frontend-manager-ultimate'),
                                'attributes'  => array('readonly' => true),
                                'value'       => $verify_twitter_redirect_url,
                            ),
                            'verify_twitter_client_id' => array(
                                'label'       => __('Consumer key', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verify_twitter_client_id]',
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele',
                                'label_class' => 'wcfm_title wcfm_ele',
                                'hints'       => __('App generated Consumer Key required.', 'wc-frontend-manager-ultimate'),
                                'value'       => $verify_twitter_client_id,
                            ),
                            'verify_twitter_client_secret' => array(
                                'label'       => __('Consumer Secret', 'wc-frontend-manager-ultimate'),
                                'name'        => 'wcfm_vendor_verification_options[verify_twitter_client_secret]',
                                'type'        => 'text',
                                'class'       => 'wcfm-text wcfm_ele',
                                'label_class' => 'wcfm_title wcfm_ele',
                                'hints'       => __('App generated Consumer Secret required.', 'wc-frontend-manager-ultimate'),
                                'value'       => $verify_twitter_client_secret,
                            ),
                        )
                    )
                );
    ...
    {
        printf(__('%1$sVerify your profile to add more products >>%2$s', 'wc-frontend-manager-ultimate'), '<a style="text-decoration: underline; margin-left: 10px; color: #00897b;" href="' . apply_filters('wcfm_verify_profile_url', get_wcfm_profile_url() . '#sm_profile_manage_form_verification_head') . '">', '</a>');
    }
    ...
    function wcfmu_vendor_verification_user_profile_fields()
    {
        ...
        if (!$vendor_verification_data) {
            $vendor_verification_data = array();
        }

        $verification_status = 'noprompt';
        if (!empty($vendor_verification_data) && isset($vendor_verification_data['verification_status'])) {
            $verification_status = $vendor_verification_data['verification_status'];
        }
        ...
        if ($verify_by_google || $verify_by_facebook || $verify_by_linkedin || $verify_by_twitter) {
            $is_social_verification_enabled = true;
        }
        ...
        if ($is_social_verification_enabled) {
            if ($verification_status == 'approve') {
                if (!isset($vendor_verification_data['social'])) {
                    ...
                    if ($verify_by_google && !isset($vendor_verification_data['social']['Google'])) {
                        $verification_status = 'social_pending';
                    } elseif ($verify_by_twitter && !isset($vendor_verification_data['social']['Twitter'])) {
                        $verification_status = 'social_pending';
                    } elseif ($verify_by_linkedin && !isset($vendor_verification_data['social']['Linkedin'])) {
                        $verification_status = 'social_pending';
                    } elseif ($verify_by_facebook && !isset($vendor_verification_data['social']['Facebook'])) {
                        $verification_status = 'social_pending';
                    } else {
            ...
            <div id="wcfm_profile_manage_form_verification_expander" class="wcfm-content">
                ...
                if ($verification_status != 'pending') {
                    ...
                    if ($verification_status != 'social_pending') {
                        $WCFM->wcfm_fields->wcfm_generate_form_field(
                            apply_filters(
                                'wcfm_vendor_verification_prompt_fields',
                                array(
                                    'prompt_verify' => array(
                                        'label'       => __('Prompt Verify', 'wc-frontend-manager-ultimate'),
                                        'name'        => 'vendor_verification[prompt_verify]',
                                        'type'        => 'checkbox',
                                        'class'       => 'wcfm-checkbox wcfm_ele',
                                        'label_class' => 'wcfm_title checkbox_title wcfm_ele',
                                        'value'       => 'yes',
                                        'hints'       => __('Check this to submit your verification data to admin.', 'wc-frontend-manager-ultimate'),
                                    ),
                                )
                            )
                        );
                ...
                ?>
                        ...
                        if (!empty($identity_types)) {
                            foreach ($identity_types as $identity_type) {
                                if (isset($identity_type['is_active'])) {
                                    $identity_type_value = '';
                                    if (!empty($vendor_verification_data) && isset($vendor_verification_data['identity']) && isset($vendor_verification_data['identity'][$identity_type['identity_id']])) {
                                        $identity_type_value = $vendor_verification_data['identity'][$identity_type['identity_id']];
                                    }
                                    $WCFM->wcfm_fields->wcfm_generate_form_field(
                                        array(
                                            $identity_type['identity_id'] => array(
                                                'label'   => __($identity_type['identity_name'], 'wc-frontend-manager-ultimate'),
                                                'name'    => 'vendor_verification[identity][' . $identity_type['identity_id'] . ']',
                                                'type'    => 'upload',
                                                'mime'    => 'Uploads',
                                                'class'   => 'wcfm-text',
                                                'label_class' => 'wcfm_title',
                                                'prwidth' => 32,
                                                'value'   => $identity_type_value,
                                            ),
                                        )
                                    );
                                }
                    ...
                    <?php if (apply_filters('wcfm_is_allow_vendor_address_verification', true)) { ?>
                        ...
                        $WCFM->wcfm_fields->wcfm_generate_form_field(
                            apply_filters(
                                'wcfm_vendor_verification_profile_fields_address',
                                array(
                                    'vstreet_1' => array(
                                        'label'       => __('Street', 'wc-frontend-manager'),
                                        'placeholder' => __('Street address', 'wc-frontend-manager'),
                                        'name'        => 'vendor_verification[address][street_1]',
                                        'type'        => 'text',
                                        'class'       => 'wcfm-text wcfm_ele',
                                        'label_class' => 'wcfm_title wcfm_ele',
                                        'value'       => $street_1,
                                    ...
                                    'vstreet_2' => array(
                                        'label'       => __('Street 2', 'wc-frontend-manager'),
                                        'placeholder' => __('Apartment, suite, unit etc. (optional)', 'wc-frontend-manager'),
                                        'name'        => 'vendor_verification[address][street_2]',
                                        'type'        => 'text',
                                        'class'       => 'wcfm-text wcfm_ele',
                                        'label_class' => 'wcfm_title wcfm_ele',
                                        'value'       => $street_2,
                                    ...
                                    'vcity'     => array(
                                        ...
                                        'placeholder' => __('Town / City', 'wc-frontend-manager'),
                                        'name'        => 'vendor_verification[address][city]',
                                        'type'        => 'text',
                                        'class'       => 'wcfm-text wcfm_ele',
                                        'label_class' => 'wcfm_title wcfm_ele',
                                        'value'       => $city,
                                    ...
                                    'vzip'      => array(
                                        ...
                                        'placeholder' => __('Postcode / Zip', 'wc-frontend-manager'),
                                        'name'        => 'vendor_verification[address][zip]',
                                        'type'        => 'text',
                                        'class'       => 'wcfm-text wcfm_ele',
                                        'label_class' => 'wcfm_title wcfm_ele',
                                        'value'       => $zip,
                                    ...
                                    'vcountry'  => array(
                                        ...
                                        'name'        => 'vendor_verification[address][country]',
                                    ...
                                    'vstate'    => array(
                                        ...
                                        'name'        => 'vendor_verification[address][state]',
                                        'type'        => 'text',
                                        'class'       => 'wcfm-text wcfm_ele',
                                        'label_class' => 'wcfm_title wcfm_ele',
                                        'value'       => $state,
        ...
        ?>
                <form id="wcfm_verification_response_form" class="wcfm_popup_wrapper">
                    <div style="margin-bottom: 15px;">
                        <h2 style="float: none;"><?php _e('Vendor Verification', 'wc-frontend-manager-ultimate'); ?></h2>
                    </div>
                    <table>
                        <tbody>
                            <?php
        ...
        if (isset($wcfm_verification_response_form_data['wcfm_verification_message_id']) && isset($wcfm_verification_response_form_data['wcfm_verification_vendor_id'])) {
            ...
            if ($vendor_id && $message_id) {
                ...
                if ($verification_status == 'reject') {
                    ...
                    $raw_message = [
                        'l10n'	=> [
                            'text' 		=> '<b>Opps!!!</b> Your verification rejected, please try again. <br />Added note: %s',
                    ...
                    $raw_message = [
                        'l10n'	=> [
                            'text' 		=> '<b>Congratulation!!!</b> Your verification approved. <br />Added note: %s',
                            'domain'    => 'wc-frontend-manager-ultimate',
                            'wrapper'	=> [
                                'function' 	=> 'sprintf',
                                'args' 		=> [
                ...
                $WCFM->wcfm_notification->wcfm_send_direct_message($author_id, $message_to, $author_is_admin, $author_is_vendor, $wcfm_messages, 'verification', true, $raw_message);
                ...
                <div class="wcfmvm_verification_details">
                            ...
                            foreach ($identity_types as $identity_type) {
                                if (isset($identity_type['is_active'])) {
                                    ...
                                    $WCFM->wcfm_fields->wcfm_generate_form_field(
                                        array(
                                            $identity_type['identity_id'] => array(
                                                'label'   => $identity_type['identity_name'],
                                                'name'    => 'vendor_verification[identity][' . $identity_type['identity_id'] . ']',
                                                'type'    => 'upload',
                                                'mime'    => 'Uploads',
                                                'mime_class' => 'wcfm_linked_attached',
                                                'class'   => 'wcfm-text',
                                                'label_class' => 'wcfm_title',
                                                'prwidth' => 32,
                                                'value'   => $identity_type_value,
                    ...
                    <div class="wcfmvm_verification_address_details">
                        ...
                        if (!isset($vendor_verification_data['address'])) {
                            $vendor_verification_data['address'] = array();
                        }
                ...
                <div class="wcfm_vendor_verification_manage">
                    <form id="wcfm_vendor_manage_verification_form" class="wcfm">
                        ...
                        if ($verification_status == 'approve') {
                            $WCFM->wcfm_fields->wcfm_generate_form_field(
                                array(
                                    'wcfm_verification_response_status' => array(
                                        'type'  => 'hidden',
                                        'value' => 'reject',
                                    ),
                                )
                        ...
                        $WCFM->wcfm_fields->wcfm_generate_form_field(
                            array(
                                'wcfm_verification_vendor_id' => array(
                                    'type'  => 'hidden',
                                    'value' => $vendor_id,
                                ),
                            )
                        ...
                        $WCFM->wcfm_fields->wcfm_generate_form_field(
                            array(
                                'wcfm_verification_response_note' => array(
                                    'label'             => __('Note to Vendor', 'wc-frontend-manager-ultimate'),
                                    'type'              => 'textarea',
                                    'value'             => '',
                        ...
                        <div id="wcfm_verification_submit">
                            ...
                            <?php
                            if ($verification_status == 'approve') {
                                _e('Mark Unapproved', 'wc-frontend-manager-ultimate');
                            } else {
                                _e('Mark Approved', 'wc-frontend-manager-ultimate');
                            }
                            ?>
                            " id="wcfm_vendor_verification_save_button" class="wcfm_submit_button" />
                        </div>
                        <div class="wcfm-clearfix"></div>
                    </form>
                </div>
...
<?php
        ...
        if (isset($wcfm_verification_response_form_data['wcfm_verification_vendor_id'])) {
            ...
            if ($vendor_id) {
                ...
                if ($verification_status == 'reject') {
                    ...
                    $raw_message = [
                        'l10n'	=> [
                            'text' 		=> '<b>Opps!!!</b> Your verification has been rejected, please try again. <br />Added note: %s',
                            'domain'    => 'wc-frontend-manager-ultimate',
                            'wrapper'	=> [
                                'function' 	=> 'sprintf',
                                'args' 		=> [
                    ...
                    $raw_message = [
                        'l10n'	=> [
                            'text' 		=> '<b>Congratulation!!!</b> Your verification has been approved. <br />Added note: %s',
                            'domain'    => 'wc-frontend-manager-ultimate',
                            'wrapper'	=> [
                                'function' 	=> 'sprintf',
                                'args' 		=> [
    ...
    function wcfmu_vendor_verification_product_limit($product_limit, $vendor_id = 0)
    {
        ...
        if (wcfm_is_vendor()) {
            ...
            if (!$this->is_verified_vendor($vendor_id)) {
                $vendor_verification_options = get_option('wcfm_vendor_verification_options', array());
                $verification_product_limit  = isset($vendor_verification_options['verification_product_limit']) ? $vendor_verification_options['verification_product_limit'] : '';
                if ($verification_product_limit) {
                    $product_limit = $verification_product_limit;
                }
                if ($verification_product_limit == '-1') {
                    $product_limit = -1;
                }
                if ($verification_product_limit == '0') {
                    $product_limit = 1989;
                }
            }
        }
    ...
    public function is_verified_vendor($vendor_id)
    {
        ...
        if (!empty($vendor_verification_data) && isset($vendor_verification_data['social_verification_status'])) {
            $social_verification_status = $vendor_verification_data['social_verification_status'];
        }

        if (($verification_status == 'approve') && ($social_verification_status == 'approve')) {
            return true;
        }
