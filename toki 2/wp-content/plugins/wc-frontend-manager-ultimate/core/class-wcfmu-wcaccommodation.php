...
class WCFM_WCAccommodation
{
        ...
        if ($wcfm_is_allow_accommodation = apply_filters('wcfm_is_allow_accommodation', true)) {
            if (wcfm_is_booking()) {
                if (current_user_can('manage_bookings_settings') || current_user_can('manage_bookings')) {
                    ...
                    add_filter('wcfm_product_types', [ &$this, 'wcba_product_types' ], 30);

                    // Booking Accommodation Product Type Capability
                    add_filter('wcfm_capability_settings_fields_product_types', [ &$this, 'wcfmcap_product_types' ], 30, 3);

                    // Booking Accommodation General Block
                    add_action('after_wcfm_products_manage_general', [ &$this, 'wcba_product_manage_general' ], 20, 2);

                    // Booking Accommodation Product Manage View
                    add_action('end_wcfm_products_manage', [ &$this, 'wcba_wcfm_products_manage_form_load_views' ], 20);

                    // Bookings Accommodation Ajax Controllers
                    add_action('after_wcfm_ajax_controller', [ &$this, 'wcba_ajax_controller' ]);
                }
            }
        }
    ...
    function wcfmcap_product_types($product_types, $handler='wcfm_capability_options', $wcfm_capability_options=[])
    {
        ...
        $product_types['accommodation'] = [
            'label'       => __('Accommodation', 'wc-frontend-manager-ultimate'),
            'name'        => $handler.'[accommodation]',
            'type'        => 'checkboxoffon',
            'class'       => 'wcfm-checkbox wcfm_ele',
            'value'       => 'yes',
            'label_class' => 'wcfm_title checkbox_title',
            'dfvalue'     => $accommodation,
        ];
            ...
            <div id="wcfm_products_manage_form_accommodation_expander" class="wcfm-content">
              <?php
                $WCFM->wcfm_fields->wcfm_generate_form_field(
                    apply_filters(
                        'wcfm_accommodation_booking_general_fields',
                        [
                        ...
                        '_wc_accommodation_booking_requires_confirmation' => [
                                ...
                                'hints'       => __('Check this box if the booking requires admin approval/confirmation. Payment will not be taken during checkout.', 'woocommerce-accommodation-bookings'),
                            ],
                        ...
                        '_wc_accommodation_booking_cancel_limit'          => [
                                'label'       => __('Cancellation up till', 'woocommerce-accommodation-bookings'),
                                'type'        => 'number',
                                'class'       => 'wcfm-text wcfm_ele accommodation-booking',
                                'label_class' => 'wcfm_title accommodation-booking',
                                'value'       => $cancel_limit,
                        ...
                        '_wc_accommodation_booking_cancel_limit_unit'     => [
                                ...
                                'desc'        => __('before check-in.', 'woocommerce-accommodation-bookings'),
                            ],
    ...
    }//end wcba_product_manage_general()
    ...
    }//end wcba_wcfm_products_manage_form_load_views()
