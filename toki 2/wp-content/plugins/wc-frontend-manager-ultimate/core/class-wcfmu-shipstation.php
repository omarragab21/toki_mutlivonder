...
class WCFMu_Shipstation
{
    ...
    public function __construct()
    {
        ...
        $wcfm_shipstation_setting = get_option('wcfm_shipstation_setting', []);

        // WCFM Shipstation Setting
        add_action('end_wcfm_vendor_settings', [ &$this, 'wcfm_shipstation_setting' ]);

        // WCFM Shipstation Setting Save
        add_action('wcfm_vendor_settings_update', [ &$this, 'wcfm_shipstation_setting_save' ], 150, 2);

        // webhook listener to connect to ShipStation
        // see https://docs.woocommerce.com/document/wc_api-the-woocommerce-api-callback/
        add_action('woocommerce_api_wc_shipstation', [ &$this, 'wcfmu_shipstation_api' ]);
    ...
    public function wcfm_shipstation_setting($user_id)
    {
        ...
        <div class="wcfm-container">
            <div id="wcfm_settings_form_shipstation_expander" class="wcfm-content">
                ...
                <?php
                // wcfm_video_tutorial( 'https://docs.wclovers.com/shipstation/' );
                ?>
                ...
                $WCFM->wcfm_fields->wcfm_generate_form_field(
                    apply_filters(
                        'wcfm_settings_fields_shipstation',
                        [
                            'wcfm_shipstation_setting_auth_key'        => [
    ...
    }//end wcfm_shipstation_setting_save()
