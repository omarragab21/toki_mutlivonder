    ...
    public function wcs_load_scripts($end_point)
    {
        ...
        switch ($end_point) {
            case 'wcfm-subscriptions':
                ...
                wp_enqueue_script('wcfm_subscriptions_js', $WCFMu->library->js_lib_url.'wc_subscriptions/wcfmu-script-wcsubscriptions.js', [ 'jquery', 'dataTables_js' ], $WCFMu->version, true);
            ...
            case 'wcfm-subscriptions-manage':
                ...
                wp_register_script('wcfm_momentjs', plugin_dir_url(WC_Subscriptions::$plugin_file).'assets/js/admin/moment.min.js');
                  wp_enqueue_script('wcfm_subscriptions_manage_js', $WCFMu->library->js_lib_url.'wc_subscriptions/wcfmu-script-wcsubscriptions-manage.js', [ 'jquery', 'wcfm_jstz', 'wcfm_momentjs' ], $WCFMu->version, true);
