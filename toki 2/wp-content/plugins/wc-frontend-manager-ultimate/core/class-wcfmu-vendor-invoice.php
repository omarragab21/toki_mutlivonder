...
class WCFMu_Vendor_Invoice
{
    ...
    public function wcfmu_attach_vendor_pdf_to_email($attachments, $email_id, $the_order)
    {
        ...
        if (! in_array($email_id, apply_filters('wcfm_allowed_store_invoice_order_emails', [ 'customer_invoice', 'new_order', 'customer_on_hold_order', 'customer_completed_order', 'customer_processing_order', 'store-new-order', 'new_renewal_order', 'customer_processing_renewal_order', 'customer_completed_renewal_order', 'customer_renewal_invoice' ])) || get_post_type($order_id) != 'shop_order') {
            return $attachments;
        }
