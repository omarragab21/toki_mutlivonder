      ...
      <?php do_action('before_wcfm_appointments_calendar'); ?>
        ...
        <div class="wcfm-container">
          <div id="wwcfm_appointments_listing_expander" class="wcfm-content">
            <?php
            require_once WC_APPOINTMENTS_ABSPATH.'includes/admin/class-wc-appointments-admin.php';

            if ( defined( 'WC_APPOINTMENTS_VERSION' ) && version_compare( WC_APPOINTMENTS_VERSION, '4.15.0', '>=' ) ) {
                require_once $WCFMu->plugin_path.'includes/appointments_calendar/class-wcfm-appointments-calendar.php';
            } else {
                require_once $WCFMu->plugin_path.'includes/appointments_calendar/class-wcfm-appointments-calendar-deprecated.php';
            }
