...
<tr>
    ...
    <div class="bookings-datetime-select-from">
        ...
        <div class="from_time">
            <input type="time" class="time-picker wcfm-text" style="width:100%;" name="wc_booking_availability_from_time[]" value="
            <?php
    ...
    <div class='bookings-datetime-select-to'>
        ...
        <div class="to_time">
            <input type="time" class="time-picker wcfm-text" style="width:100%;" name="wc_booking_availability_to_time[]" value="
            <?php
