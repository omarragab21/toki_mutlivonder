...
if ( ! empty($field_groups) ) {
    foreach ( $field_groups as $field_group_index => $field_group ) {
        ...
        if ( in_array($field_group['ID'], $cat_group_ids) ) {
            $cat_group_class = 'wcfm_cat_based_acf_pro_product_manager_fields';
        }
                                        ...
                                        $WCFM->wcfm_fields->wcfm_generate_form_field(
                                            array(
                                                $field_group_field['name'] => array(
                                                    ...
                                                    'name' => 'acf[' . $field_group_field['name'] . ']',
                                                    'type' => 'select',
                                                    'class' => 'wcfm-select wcfm-acf-pro-multi-select wcfm_ele simple variable external grouped booking ' . $field_group_field['key'],
                                                    'label_class' => 'wcfm_title ' . $field_group_field['key'],
                                                    'attributes' => array(
                                                        'multiple' => 'multiple',
                                                        'style'    => 'width: 60%;',
