        ...
        $WCFM->wcfm_fields->wcfm_generate_form_field(
            apply_filters(
                ...
                array(
                    ...
                    'perkilo_price'        => array(
                        'label'       => __('Per Kilometer Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                        'type'        => 'number',
                        'class'       => 'wcfm-text wcfm_ele redq_rental',
                        'label_class' => 'wcfm_title redq_rental',
                        'value'       => $perkilo_price,
                    ...
                    'friday_price'         => array(
                        'label'       => __('Friday Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                    ...
                    'saturday_price'       => array(
                        'label'       => __('Saturday Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                    ...
                    'sunday_price'         => array(
                        'label'       => __('Sunday Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                    ...
                    'monday_price'         => array(
                        'label'       => __('Monday Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                    ...
                    'tuesday_price'        => array(
                        'label'       => __('Tuesday Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                    ...
                    'wednesday_price'      => array(
                        'label'       => __('Wednesday Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
                    ...
                    'thursday_price'       => array(
                        'label'       => __('Thursday Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')',
