    ...
    <div id="wcfm_products_manage_form_yithauction_expander" class="wcfm-content">
        ...
        $wcsauction_fields = apply_filters(
            ...
            [
                '_auction_item_condition' => [
                    'label'       => __('Item condition', 'wc-frontend-manager-ultimate'),
                    'type'        => 'select',
                    'class'       => 'wcfm-select wcfm_ele auction',
                    'label_class' => 'wcfm_title auction',
                    'options'     => [
                        'new'  => __('New', 'wc-frontend-manager-ultimate'),
                        'used' => __('Used', 'wc-frontend-manager-ultimate'),
                    ],
                    'value'       => $_auction_item_condition,
                ],
                '_auction_type'           => [
                    'label'       => __('Auction type', 'wc-frontend-manager-ultimate'),
                    'type'        => 'select',
                    'class'       => 'wcfm-select wcfm_ele auction',
                    'label_class' => 'wcfm_title auction',
                    'options'     => [
                        'normal'  => __('Normal', 'wc-frontend-manager-ultimate'),
                        'reverse' => __('Reverse', 'wc-frontend-manager-ultimate'),
                    ],
                    'value'       => $_auction_type,
                ],
                '_auction_proxy'          => [
                    'label'       => __('Proxy bidding?', 'wc-frontend-manager-ultimate'),
                    'type'        => 'checkbox',
                    'class'       => 'wcfm-checkbox wcfm_ele auction',
                    'label_class' => 'wcfm_title auction',
                    'value'       => 'yes',
                    'dfvalue'     => $_auction_proxy,
                    'hints'       => __('Enable proxy bidding', 'wc_simple_auctions'),
                ],
                '_auction_sealed'         => [
                ...
                '_regular_price'          => [
                    ...
                    'hints'       => __('Buy it now disappears when bid exceeds the Buy now price for normal auction, or is lower than reverse auction', 'wc-frontend-manager-ultimate'),
                ],
                '_auction_dates_from'     => [
                    'label'       => __('Auction Date From', 'wc-frontend-manager-ultimate'),
                    'type'        => 'text',
                    'placeholder' => _x('From&hellip; YYYY-MM-DD HH:MM', 'placeholder', 'wc_simple_auctions'),
                    'attributes'  => [
                        'maxlength' => 16,
                ...
                '_auction_dates_to'       => [
                    ...
                    'type'        => 'text',
                    'placeholder' => _x('To&hellip; YYYY-MM-DD HH:MM', 'placeholder', 'wc_simple_auctions'),
                    'attributes'  => [
                        'maxlength' => 16,
                        'pattern'   => '[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])[ ](0[0-9]|1[0-9]|2[0-4]):(0[0-9]|1[0-9]|2[0-9]|3[0-9]|4[0-9]|5[0-9])',
                    ],
        ...
        $WCFM->wcfm_fields->wcfm_generate_form_field(
            apply_filters(
                ...
                [
                    '_auction_automatic_relist'     => [
                        'label'       => __('Automatic relist auction', 'wc-frontend-manager-ultimate'),
                        'type'        => 'checkbox',
                        'class'       => 'wcfm-checkbox wcfm_ele auction',
                        'label_class' => 'wcfm_title auction',
                        'value'       => 'yes',
                        'dfvalue'     => $_auction_automatic_relist,
                        'hints'       => __('Enable automatic relisting', 'wc_simple_auctions'),
                    ],
                    '_auction_relist_fail_time'     => [
                        'label'       => __('Relist if fail after n hours', 'wc-frontend-manager-ultimate'),
                        'type'        => 'number',
                        'class'       => 'wcfm-text wcfm_ele auction',
                        'label_class' => 'wcfm_title auction',
                    ...
                    '_auction_relist_not_paid_time' => [
                        'label'       => __('Relist if not paid after n hours', 'wc-frontend-manager-ultimate'),
                        'type'        => 'number',
                        'class'       => 'wcfm-text wcfm_ele auction',
                        'label_class' => 'wcfm_title auction',
                    ...
                    '_auction_relist_duration'      => [
                        'label'       => __('Relist auction duration in h', 'wc-frontend-manager-ultimate'),
                        'type'        => 'number',
                        'class'       => 'wcfm-text wcfm_ele auction',
                        'label_class' => 'wcfm_title auction',
