                        ...
                        <div id="wcfm_new_reply_listing_expander" class="wcfm-content">
                            ...
                            $wcfm_support_ticket_reply_fields = apply_filters(
                                ...
                                array(
                                    ...
                                    'support_order_id'     => array(
                                        'type'  => 'hidden',
                                        'value' => $support_order_id,
                                    ),
                                    'support_item_id'      => array(
                                        'type'  => 'hidden',
                                        'value' => $support_item_id,
                                    ),
                                    'support_product_id'   => array(
                                        'type'  => 'hidden',
                                        'value' => $support_product_id,
                                    ),
                                    'support_vendor_id'    => array(
                                        'type'  => 'hidden',
                                        'value' => $support_vendor_id,
                                    ),
                                    'support_customer_id'  => array(
                                        'type'  => 'hidden',
                                        'value' => $support_customer_id,
                                    ),
                                    'support_customer_name' => array(
                                        'type'  => 'hidden',
                                        'value' => $support_customer_name,
                                    ),
                                    'support_customer_email' => array(
                                        'type'  => 'hidden',
                            ...
                            if ( ( $wcfm_support_allow_attachment == 'no' ) || ! apply_filters('wcfm_is_allow_support_reply_attachment', true) ) {
                                if ( isset($wcfm_enquiry_reply_fields['support_attachments']) ) {
                                    unset($wcfm_enquiry_reply_fields['support_attachments']);
                                }
                                if ( isset($wcfm_enquiry_reply_fields['support_reply_break2']) ) {
                                    unset($wcfm_enquiry_reply_fields['support_reply_break2']);
                                }
                            }
