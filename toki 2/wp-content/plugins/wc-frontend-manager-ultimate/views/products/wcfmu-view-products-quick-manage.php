...
if ( isset($_POST['product']) ) {
    ...
    if ( ! empty($wcfm_custom_validation_options) ) {
        if ( isset($wcfm_custom_validation_options['sku']) ) {
            $sku_required = true;
        }
        if ( isset($wcfm_custom_validation_options['regular_price']) ) {
            $price_required = true;
        }
        if ( isset($wcfm_custom_validation_options['sale_price']) ) {
            $sales_price_required = true;
        }
        if ( isset($wcfm_custom_validation_options['stock_qty']) ) {
            $stock_required = true;
        }
    }
          ...
          <tbody>
            ...
            <?php if ( apply_filters('wcfm_is_allow_sku', true) && $is_manage_sku ) { ?>
                        <tr class="<?php echo $wcfm_wpml_edit_disable_element; ?>">
                            <td>
                              <p class="wcfm_quick_edit_form_label wcfm_popup_label"><?php _e('SKU', 'wc-frontend-manager-ultimate'); ?>
                                                                                               <?php
                                                                                                if ( $sku_required ) {
                                                                                                    ?>
<span class="required">*</span><?php } ?></p>
                              <input type="text" name="wcfm_quick_edit_sku" class="wcfm_popup_input" value="<?php echo get_post_meta($product_id, '_sku', true); ?>" 
                                                                                                                       <?php
                                                                                                                        if ( $sku_required ) {
                                                                                                                            ?>
                                    data-required="1" data-required_message="<?php echo __('SKU', 'wc-frontend-manager-ultimate') . ': ' . __('This field is required.', 'wc-frontend-manager'); ?>"<?php 
                                                                                                                        } ?> />
                            </td>
                        </tr>
            <?php } ?>
            <?php if ( in_array($product->get_type(), array( 'simple', 'external' )) ) { ?>
                <?php if ( $is_manage_price ) { ?>
                            <tr class="<?php echo $wcfm_wpml_edit_disable_element; ?>">
                                <td>
                                  <p class="wcfm_quick_edit_form_label wcfm_popup_label"><?php _e('Regular Price', 'wc-frontend-manager-ultimate'); ?>
                                                                                                   <?php
                                                                                                    if ( $price_required ) {
                                                                                                        ?>
<span class="required">*</span><?php } ?></p>
                                  <input type="number" name="wcfm_quick_edit_regular_price" class="wcfm_popup_input" value="<?php echo get_post_meta($product_id, '_regular_price', true); ?>" 
                                                                                                                                       <?php
                                                                                                                                        if ( $price_required ) {
                                                                                                                                            ?>
                                        data-required="1" data-required_message="<?php echo __('Regular Price', 'wc-frontend-manager-ultimate') . ': ' . __('This field is required.', 'wc-frontend-manager'); ?>"<?php 
                                                                                                                                        } ?> />
                                </td>
                            </tr>
                <?php } ?>
                        <?php if ( $is_manage_sales_price ) { ?>
                            <tr class="<?php echo $wcfm_wpml_edit_disable_element; ?>">
                                <td>
                                  <p class="wcfm_quick_edit_form_label wcfm_popup_label"><?php _e('Sale Price', 'wc-frontend-manager-ultimate'); ?>
                                                                                                   <?php
                                                                                                    if ( $sales_price_required ) {
                                                                                                        ?>
<span class="required">*</span><?php } ?></p>
                                  <input type="number" name="wcfm_quick_edit_sale_price" class="wcfm_popup_input" value="<?php echo get_post_meta($product_id, '_sale_price', true); ?>" 
                                                                                                                                    <?php
                                                                                                                                    if ( $sales_price_required ) {
                                                                                                                                        ?>
                                        data-required="1" data-required_message="<?php echo __('Sale Price', 'wc-frontend-manager-ultimate') . ': ' . __('This field is required.', 'wc-frontend-manager'); ?>"<?php 
                                                                                                                                    } ?> />
                                </td>
                            </tr>
                        <?php } ?>
            ...
            <?php if ( $product->get_type() == 'simple' && $product->managing_stock() && apply_filters('wcfm_is_allow_inventory', true) ) { ?>
                        <tr class="<?php echo $wcfm_wpml_edit_disable_element; ?>">
                            <td>
                              <p class="wcfm_quick_edit_form_label wcfm_popup_label"><?php _e('Stock', 'wc-frontend-manager-ultimate'); ?>
                                                                                               <?php
                                                                                                if ( $stock_required ) {
                                                                                                    ?>
<span class="required">*</span><?php } ?></p>
                              <input type="number" name="wcfm_quick_edit_stock" class="wcfm_popup_input" value="<?php echo $product->get_total_stock(); ?>" 
                                                                                                                           <?php
                                                                                                                            if ( $stock_required ) {
                                                                                                                                ?>
                                    data-required="1" data-required_message="<?php echo __('Stock', 'wc-frontend-manager-ultimate') . ': ' . __('This field is required.', 'wc-frontend-manager'); ?>"<?php 
                                                                                                                            } ?> />
                            </td>
                        </tr>
            <?php } ?>
                                    ...
                                    apply_filters(
                                        ...
                                        array(
                                            'catalog_visibility' => array(
                                                ...
                                                'class'   => 'wcfm-select wcfm_ele wcfm_popup_input',
