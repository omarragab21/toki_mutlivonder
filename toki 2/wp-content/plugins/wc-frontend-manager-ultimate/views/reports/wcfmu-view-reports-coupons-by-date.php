...
require_once $WCFMu->plugin_path.'/includes/reports/class-wcfm-report-coupon-usage.php';
...
$wcfm_report_coupons_by_date->chart_colours = [
  ...
  <div class="wcfm-page-headig">
        ...
        <span class="wcfm-page-heading-text">
          <?php if ('custom' === $current_range && isset($_GET['start_date'], $_GET['end_date'])) : ?>
                <?php _e('Coupons by Date', 'wc-frontend-manager-ultimate'); ?> - <?php echo esc_html(sprintf(_x('From %1$s to %2$s', 'start date and end date', 'wc-frontend-manager-ultimate'), wc_clean($_GET['start_date']), wc_clean($_GET['end_date']))); ?><span></span>
          <?php else : ?>
      ...
      <div class="wcfm-clearfix"></div><br />
        ...
        <div class="wcfm-container">
            <div id="wcfm_reports_coupons_by_date_expander" class="wcfm-content">
                ...
                <?php
                require $WCFMu->plugin_path.'/views/reports/wcfmu-html-report-coupons-by-date.php';
                ?>
                <div class="wcfm-clearfix"></div>
            </div>
        </div>
