    ...
    <tr>
        ...
        <td class="address shipping-address">
            ...
            <h3><?php _e('Ship To:', 'wc-frontend-manager-ultimate'); ?></h3>
                <?php echo wp_kses($order->get_formatted_shipping_address(), [ 'br' => [] ]); ?>
            <?php } ?>
    <?php
                ...
                <table class="totals">
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td class="total price" style="text-align:center;">
                                <div class="view"><?php echo wc_price($invoice_total, [ 'currency' => $order->get_currency() ]); ?></div>
                            </td>
                        </tr>
...
if (apply_filters('wcfm_is_allow_order_details_after_order_table', false)) {
    echo '<table class="order-details"><tbody><tr><td>';
...
<?php endif; ?>
<?php
do_action('wcfm_packing_slip_after_document', $document_type, $order);
