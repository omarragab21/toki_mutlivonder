                                    ...
                                    <div class="form-field form-field-wide downloadable_files">
                                        ...
                                        if (! $downloadable_files) {
                                            ...
                                            $WCFM->wcfm_fields->wcfm_generate_form_field(
                                                [
                                                    'wc_quotation_attached_files' => [
                                                        'label'       => __('File(s)', 'wc-frontend-manager-ultimate'),
                                                        'type'        => 'multiinput',
        ...
        <div id="orders_details_shipment_expander" class="wcfm-content">
          ...
          <table cellpadding="0" cellspacing="0" class="woocommerce_order_items">
                ...
                if ($is_marketplace == 'wcvendors') {
                    ...
                    $shipped_action = 'wcfm_wcpvendors_order_mark_fulfilled';
                } else if ($is_marketplace == 'wcmarketplace') {
                    $shipped_action = 'wcfm_wcmarketplace_order_mark_shipped';
                } else if ($is_marketplace == 'wcfmmarketplace') {
                    $shipped_action = 'wcfm_wcfmmarketplace_order_mark_shipped';
                } else if ($is_marketplace == 'dokan') {
                    $shipped_action = 'wcfm_dokan_order_mark_shipped';
                }
                    ...
                    if ($needs_shipping) {
                        ...
                        foreach ($item->get_formatted_meta_data() as $meta_id => $meta) {
                            if ($meta->key == 'wcfm_tracking_url') {
                                ...
                                $shipped      = true;
                            } else if ($meta->key == 'wcfm_tracking_code') {
                                $tracking_code = $meta->value;
                            } else if ($meta->key == 'wcfm_delivery_boy') {
                    ...
                    foreach ($notes as $note) {
                        ...
                        ?>
                            <tr class="<?php echo esc_attr(implode(' ', $note_classes)); ?>">
                                ...
                                <?php
                                if ($note->comment_author !== __('WooCommerce', 'wc-frontend-manager-ultimate')) {
                                    printf(' '.__('by %s', 'wc-frontend-manager-ultimate'), $note->comment_author);
                                }
                                ?>
                                </td>
                            </tr>
