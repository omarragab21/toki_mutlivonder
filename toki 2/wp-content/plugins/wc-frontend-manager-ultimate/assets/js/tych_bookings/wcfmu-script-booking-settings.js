jQuery( document ).ready(
	function ($) {
		...
		{
			$( '#wc_global_booking_availability' ).find( '.multi_input_block' ).each(
				function () {
					if ($( this ).find( '.avail_range_type' ).parent().is( "span" )) {
						$( this ).find( '.avail_range_type' ).unwrap( "span" ); }
		...
		availabilityRules();
		$( '#wc_global_booking_availability' ).find( '.add_multi_input_block' ).click(
			function () {
				availabilityRules();
		...
		// Submit Resource
		$( '#wcfm_wcbookings_settings_submit_button' ).click(
			function (event) {
