...
class WCFMu_WCBookings_Products_Manage_Controller
{
    ...
    public function __construct()
    {
        ...
        add_filter('wcfm_booking_data_factory', [ &$this, 'wcfmu_booking_data_factory' ], 20, 4);

        // Booking Resource and Person Manager
        add_filter('wcfm_booking_data_factory', [ &$this, 'wcfmu_booking_resource_person_data_factory' ], 30, 4);
    ...
    }//end wcfmu_booking_data_factory()
    ...
    }//end wcfmu_booking_resource_person_data_factory()
