...
class WCFMu_Support_Form_Controller
{
    ...
    public function processing()
    {
        ...
        } else if (class_exists('anr_captcha_class') && function_exists('anr_captcha_form_field')) {
        ...
        if (isset($wcfm_support_tab_form_data['wcfm_support_query']) && ! empty($wcfm_support_tab_form_data['wcfm_support_query'])) {
            ...
            if (isset($support_categories[$support_category])) {
                $support_category = $support_categories[$support_category];
            }
            ...
            if ($support_ticket_id) {
                ...
                $reply_mail_body    = '<br/>'.__('Hi', 'wc-frontend-manager-ultimate').',<br/><br/>'.sprintf(__('You have recently received a support request for "%s". Please check below for the details: ', 'wc-frontend-manager-ultimate'), '{product_title}').'<br/><br/><strong><i>'.'"{support}"'.'</i></strong><br/><br/>'.__('Check more details here', 'wc-frontend-manager-ultimate').': <a href="{support_url}">'.__('Ticket', 'wc-frontend-manager-ultimate').' #{support_ticket_id}</a>'.'<br /><br/>'.__('Thank You', 'wc-frontend-manager-ultimate').'<br/><br/>';
