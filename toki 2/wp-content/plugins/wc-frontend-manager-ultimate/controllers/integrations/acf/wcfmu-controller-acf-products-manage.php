...
class WCFMu_ACF_Products_Manage_Controller
{
    ...
    public function __construct()
    {
        ...
        add_action('after_wcfm_products_manage_meta_save', [ &$this, 'wcfm_acf_products_manage_meta_save' ], 160, 2);
                    ...
                    if (! empty($field_group_fields)) {
                        if (! empty($field_group_fields)) {
                            foreach ($field_group_fields as $field_group_field) {
                                ...
                                } else if ($field_group_field['type'] == 'checkbox' || $field_group_field['type'] == 'true_false' || $field_group_field['type'] == 'radio') {
                                    if (! isset($wcfm_products_manage_form_data['acf'][$field_group_field['name']]) && empty($wcfm_products_manage_form_data['acf'][$field_group_field['name']])) {
    ...
    }//end wcfm_acf_products_manage_meta_save()
