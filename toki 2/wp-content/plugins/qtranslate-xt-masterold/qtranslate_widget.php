        ...
        case 'dropdown':
            {
                foreach ( qtranxf_getSortedLanguages() as $language ) {
                    ...
                    echo '>';
                    if ( $type == 'image' ) {
                        echo '<label>'.$q_config['language_name'][ $language ].'<img class="qtranxs-flag" src="' . $flag_location . $q_config['flag'][ $language ] . '" alt="' . $alt . '" /></label>';
                    }
                    echo '<span';
        ...
        case 'short':
            {
                ...
                foreach ( qtranxf_getSortedLanguages() as $language ) {
                    ...
                    echo '<a';
                    if ( $language == $q_config['language'] ) {
                        echo ' class="langactive" ';
                    }
                    echo ' href="' . qtranxf_convertURL( $url, $language, false, true ) . '"';
