...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) &&isset($_GET['register']) ) : ?>
    ...
    <form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
     ...
     <input placeholder=" <?php _e("<!--:en-->UserName<!--:--><!--:ar-->  اسم المستخدم  <!--:-->");?> *" type="text" class="form-control" name="username" id="reg_username" autocomplete="username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( wp_unslash( $_POST['username'] ) ) : ''; ?>" /><?php // @codingStandardsIgnoreLine ?>
</div>
 ...
 <?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
        ...
        <?php wp_nonce_field( 'woocommerce-register', 'woocommerce-register-nonce' ); ?>
                ...
                <button type="submit" class="ctm-btn" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></button>
                                ...
                                <div class="link_form_login_page">  
  <?php _e("<!--:en-->Already Have Account<!--:--><!--:ar-->لديك حساب   بالفعل <!--:-->"); ?>
