...
?>
  ...
  <section class="success_order">
	...
	if ( $order ) :
		...
		?>
           <div class="col-lg-12">
                            <div class="title_success_order">
                                <img src="<?php bloginfo('template_directory'); ?>/images/bag.png" alt="">
                                <h2>
  <?php _e("<!--:en-->THANK YOU. <!--:--><!--:ar-->شكرا لك<!--:-->"); ?>
